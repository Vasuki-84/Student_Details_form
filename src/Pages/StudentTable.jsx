...
function StudentTable() {
  return (
    <div className=" mt-10 border rounded-sm mx-3 py-3 shadow-lg bg-gray-100">
      ...
      <div className="">
        <Link className="btn bg-blue-300 py-2 px-2 rounded-lg mx-2 mb-5 mt-4">
          Add new student
        </Link>
        <table className="border-collapse mt-4 mx-10 border border-gray-400 mx-auto ...">
          ...
          <tbody>
            <tr>
              ...
              <td className="border  px-5 py-2 border-gray-600 ...">
                <Link className="btn bg-yellow-300 mx-3 px-2 py-1 rounded-sm">View</Link>
                <Link className="btn bg-gray-500 mx-3 px-2 py-1 rounded-sm">Edit</Link>
